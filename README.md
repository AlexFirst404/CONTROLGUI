...
- 👥 **Игроки** — кто онлайн, убийства и смерти, просмотр и правка инвентаря и статов (свой NBT-парсер), иконки модовых предметов прямо из установленных JAR, кик / бан / OP / вайтлист.
