...
![Версия](https://img.shields.io/badge/release-2.4.0-6cc04a?style=flat-square)
...
- 🖥️ **Живая консоль** с вводом команд и контекстными подсказками, настраиваемой автопрокруткой/WARN-фильтром, графиками CPU / RAM / диска / TPS и поиском по логам.
- 📂 **Файловый менеджер** со встроенным редактором кода, загрузкой файлов и целых папок и безопасной распаковкой ZIP.
- 👥 **Игроки** — кто онлайн, убийства и смерти, просмотр и правка инвентаря и статов (свой NBT-парсер), кик / бан / OP / вайтлист.
...
- 🪟 **Удалённые панели** — подключайтесь к CONTROLGUI на других машинах прямо из приложения.
- ⚙️ **Настройки и обновления** — отдельные вкладки приложения, интерфейса и удалённого доступа; новые версии проверяются на GitHub, скачиваются с прогрессом и сверкой SHA-256.
...
| 🍎 **macOS** (Intel) | `CONTROLGUI-<v>-macos-x64.pkg` | Node.js встроен |
