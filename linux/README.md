...
## Установка .deb
```sh
sudo apt install ./controlgui_2.4.2_all.deb
```
...
## Запуск AppImage
```sh
chmod +x CONTROLGUI-2.4.2-x86_64.AppImage
./CONTROLGUI-2.4.2-x86_64.AppImage
```
